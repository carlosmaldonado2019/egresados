...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Facultad de Ciencias Administrativas</title>
	...
	<body>
		...
		<!-- Footer -->
		<footer>
			<p>Universidad Autónoma de Baja California | Facultad de Ciencias Administrativas Campus Mexicali - Mexicali Baja California Copyright 2016 ©</p>
		</footer>
		<!-- Script de Alertify -->
