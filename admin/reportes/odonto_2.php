...
//$resultado=mysqli_query($con,"call sp_reportes(". $indicador.")");
$parametro_1= array();
$parametro_2 = array();
$resultado = mysqli_query($con,"SELECT sexo,count(*)as conteo FROM `datos_personales` where sexo <> '' group by sexo");

while($row=$resultado->fetch_assoc()){

   $parametro_1[]=$row['sexo'];
...
case "3":
   ...
   $ls_titulo_grafica ='El posgrado que eligi� cubri� sus expectativas de formaci�n?';
...
case "4.2":
   ...
   $ls_titulo2_grafica = 'Adecuadas en la relaci�n teor�a y pr�ctica';
...
case "7.1":
  ...
  $ls_titulo2_grafica = 'Enfatizar los aspectos pr�cticos en la mayor�a de las materias.';
...
case "7.2":
  ...
  $ls_titulo2_grafica = 'Actualizaci�n de los contenidos';
...
case "7.3":
  ...
  $ls_titulo2_grafica = 'Dar mayor peso a la investigaci�n';
...
case "7.5":
  ...
  $ls_titulo2_grafica = 'Reducir las materias te�ricas';
...
case "8.2":
  ...
  $ls_titulo_grafica = 'Ejerces la profesi�n: ';

break;

case "10":

  $ls_titulo_grafica = 'Que tanto influy� tu preparaci�n de posgrado en el empleo actual:';

break;

case "11.1":

   $ls_titulo_grafica = '�En cu�l de los siguientes aspectos considera que impact� el posgrado que curs�? ';
...
case "11.2":
  ...
  $ls_titulo_grafica = '�En cu�l de los siguientes aspectos considera que impact� el posgrado que curs�?';
  $ls_titulo2_grafica = 'Posibilidad de incursionar en campos cient�ficos';
...
case "11.4":
   ...
   $ls_titulo_grafica = '�En cu�l de los siguientes aspectos considera que impact� el posgrado que curs�?';
  $ls_titulo2_grafica = 'Una mejor situaci�n laboral ';
...
case "12.1":
   ...
   $ls_titulo_grafica = 'Si despu�s de sus estudios de posgrado ha publicado';
...
case "12.2":
   ...
   $ls_titulo_grafica = 'Si despu�s de sus estudios de posgrado ha publicado';
  $ls_titulo2_grafica = 'Art�culos en revistas arbitradas';
...
case "12.3":
   ...
   $ls_titulo_grafica = 'Si despu�s de sus estudios de posgrado ha publicado';
  $ls_titulo2_grafica = 'Art�culos en revistas no arbitradas';
...
case "16.1":
   ...
   $ls_titulo_grafica = 'Si desea recibir informaci�n sobre las actividades que se realizan en esta Facultad marque con una �X� el tema de su inter�s:';
...
case "16.3":
   ...
   $ls_titulo_grafica = 'Si desea recibir informaci�n sobre las actividades que se realizan en esta Facultad marque con una �X� el tema de su inter�s:';
  $ls_titulo2_grafica = 'Investigaci�n';
...
case "16.4":
   ...
   $ls_titulo_grafica = 'Si desea recibir informaci�n sobre las actividades que se realizan en esta Facultad marque con una �X� el tema de su inter�s:';
  $ls_titulo2_grafica = 'Eventos acad�micos (congresos, conferencias, seminarios, talleres)';
...
// Cabecera de p�gina
    ...
    function Header()
    {
        ...
        $this->Ln(10);
        $this->Cell(190,10,'Facultad de Odontolog�a Mexicali',0,0,'C');
        $this->Ln(10);
        $this->SetFont('Arial','B',10);
        $this->Cell(190,10,'Coordinaci�n de Posgrado e Investigaci�n',0,0,'C');
        $this->Ln(10);
