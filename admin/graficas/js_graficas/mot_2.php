...
if ($rol == 1) {
    $result = mysqli_query($con,"SELECT mot_2 FROM datos_posgrado");
}else{
    $result = mysqli_query($con,"SELECT mot_2 FROM datos_posgrado WHERE posgrado='$rol' ");
}
...
<div id="mot_2" style="width: 430px; height: 200px;"></div>