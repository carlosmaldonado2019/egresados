<?php 
    ...
    if ($rol == 1) {
        $result = mysqli_query($con,"SELECT mot_5 FROM datos_posgrado");
    }else{
        $result = mysqli_query($con,"SELECT mot_5 FROM datos_posgrado WHERE posgrado='$rol' ");
    }
...
<div id="mot_5" style="width: 430px; height: 200px;"></div>