<?php 
    ...
    if ($rol == 1) {
        $result = mysqli_query($con,"SELECT mot_4 FROM datos_posgrado");
    }else{
        $result = mysqli_query($con,"SELECT mot_4 FROM datos_posgrado WHERE posgrado='$rol' ");
    }
...
<div id="mot_4" style="width: 430px; height: 200px;"></div>