...
//****************************** Empieza 17 ******************************
	...
	$('input[type=radio][name=pre17]').change(function() {
        if (this.value == 6) {
		 	...
		 	pre17_beca.hide("fast").attr("checked",false).val("no").removeAttr("required");
        }else if(this.value == 3) {
		 	pre170.hide("fast").val("no");
        	pre17_beca.val(null).show("fast");
        }else {
...
//****************************** Termina 25 ******************************
//****************************** Empieza 44 *******************************
	var pre440 = $("[name='pre440']");
	pre440.hide();

	$('input[type=radio][name=pre44]').click(function() {
        if (this.value == 3) {
		 	pre440.val(null);
		 	pre440.show("fast");
		 	pre440.focus();
